...
class NewCasePrescription extends PureComponent {
  constructor(props) {
    ...
    this.setState(
      this.state.appliance_types,
      this.state.appliance_types.set('U', '')
    );
    this.setState(
      this.state.appliance_types,
      this.state.appliance_types.set('L', '')
    );

    this.toggleLowerApplianceImages =
      this.toggleLowerApplianceImages.bind(this);
    this.toggleUpperApplianceImages =
      this.toggleUpperApplianceImages.bind(this);
  }
  ...
  toggleLowerApplianceImages = (event) => {
    if (this.state.appliance_types.get('L') === event.target.id) {
      ...
      this.setState({
        appliance_types: this.state.appliance_types.set('L', ''),
      });
    } else {
      this.setState({
        appliance_types: this.state.appliance_types.set('L', event.target.id),
      });
      this.lowerImage.current.src =
        '/images/appliance/' + event.target.id + '.png';
  ...
  toggleUpperApplianceImages = (event) => {
    if (this.state.appliance_types.get('U') === event.target.id) {
      ...
      this.setState({
        appliance_types: this.state.appliance_types.set('U', ''),
      });
    } else {
      this.setState({
        appliance_types: this.state.appliance_types.set('U', event.target.id),
      });
      this.upperImage.current.src =
        '/images/appliance/' + event.target.id + '.png';
      //console.log(this.lowerImage);
                ...
                <Accordion>
                  <Card>
                    <Accordion.Toggle as={Card.Header} eventKey="0">
                      <div className="font-weight-bold float-left">
                        &#183;&nbsp;Retainer
                      </div>
                        ...
                        <div className="retainer-appliances">
                          <div className="location">
                            ...
                            <label
                              className={
                                'location_l' +
                                (this.state.appliance_types.get('L') ===
                                'Standard_Hawley_Retainer_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                            ...
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Standard_Hawley_Retainer_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                          ...
                          <div className="location">
                            <span className="appliances">
                              - Circumferential Hawley Retainer
                            </span>
                            <label
                              className={
                                'location_l' +
                                (this.state.appliance_types.get('L') ===
                                'Circumferential_Hawley_Retainer_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                            ...
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Circumferential_Hawley_Retainer_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Circumferential_Hawley_Retainer_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Hawley with Flat Bow Rdeacetainer
                            </span>
                            <label
                              className={
                                'location_l' +
                                (this.state.appliance_types.get('L') ===
                                'Hawley_with_Flat_Bow_Retainer_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Hawley_with_Flat_Bow_Retainer_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Hawley_with_Flat_Bow_Retainer_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Hawley_with_Flat_Bow_Retainer_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Circumferential with Flat Bow Retainer
                            </span>
                            <label
                              className={
                                'location_l' +
                                (this.state.appliance_types.get('L') ===
                                'Circumferential_with_Flat_Bow_Retainer_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Circumferential_with_Flat_Bow_Retainer_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Circumferential_with_Flat_Bow_Retainer_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Circumferential_with_Flat_Bow_Retainer_U"
                            ></label>
                          </div>
                        </div>
                      </Card.Body>
                        ...
                        <div className="removalble-appliance-appliances">
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Schwartz_Appliance_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Schwartz_Appliance_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                          ...
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Sagittal_Appliance_2_Way_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Sagittal_Appliance_2_Way_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Sagittal_Appliance_2_Way_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Fan Type Removable Expander
                            </span>
                            <label
                              className={
                                'location_l deactivate' +
                                (this.state.appliance_types.get('L') ===
                                'Fan_Type_Removable_Expander_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Fan_Type_Removable_Expander_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Fan_Type_Removable_Expander_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Fan_Type_Removable_Expander_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                            ...
                            <label
                              ...
                              id="Three_Way_Expander_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Three_Way_Expander_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                        ...
                        <div className="fixed-appliance-appliances">
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Lingual_Holding_Arch_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Lingual_Holding_Arch_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                          ...
                          <div className="location">
                            <span className="appliances">
                              - Thumb Habit with Spurs
                            </span>
                            <label
                              className={
                                'location_l' +
                                (this.state.appliance_types.get('L') ===
                                'Thumb_Habit_with_Spurs_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Thumb_Habit_with_Spurs_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Thumb_Habit_with_Spurs_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                          ...
                          <div className="location">
                            <span className="appliances">
                              - Tongue Habit with Loops
                            </span>
                            <label
                              className={
                                'location_l deactivate' +
                                (this.state.appliance_types.get('L') ===
                                'Tongue_Habit_with_Loops_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Tongue_Habit_with_Loops_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Tongue_Habit_with_Loops_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                          ...
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Fixed_Anterior_Bite_Plate_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Fixed_Anterior_Bite_Plate_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Fixed_Anterior_Bite_Plate_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Rickanator/Bite Ramp
                            </span>
                            <label
                              className={
                                'location_l deactivate' +
                                (this.state.appliance_types.get('L') ===
                                'Rickanator_Bite_Ramp_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Rickanator_Bite_Ramp_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Rickanator_Bite_Ramp_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                        ...
                        <div className="splint-appliances">
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Hard_Acrylic_Night_Guard_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Hard_Acrylic_Night_Guard_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                          ...
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Thermoplastic_Night_Guard_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Thermoplastic_Night_Guard_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Thermoplastic_Night_Guard_U"
                            ></label>
                          </div>
                          <div className="location">
                          ...
                          <div className="location">
                            ...
                            <label
                              className={
                                'location_l deactivate' +
                                (this.state.appliance_types.get('L') === 'NTI_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                            ...
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') === 'NTI_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                        ...
                        <div className="fixed-expander-appliances">
                          ...
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Arnold_Expander_L"
                            ></label>
                            <label
                              className={
                                'location_u deactivate' +
                                (this.state.appliance_types.get('U') ===
                                'Arnold_Expander_U'
                                  ? ' active'
                                  : '')
                          ...
                          <div className="location">
                            ...
                            <label
                              ...
                              id="Rapid_Palatal_Expander_L"
                            ></label>
                            <label
                              className={
                                'location_u' +
                                (this.state.appliance_types.get('U') ===
                                'Rapid_Palatal_Expander_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                    ...
                    <Accordion.Collapse eventKey="7">
                      <Card.Body>
                        <div className="functional-appliance-appliances">
                          <div className="location">
                            <span className="appliances">
                              - Bionator without Screw(open)
                            </span>
                            {/*Set Appliance */}
                            <label
                              className={
                                'location_l set_appliance' +
                                (this.state.appliance_types.get('L') ===
                                'Bionator_without_Screw_open_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Bionator_without_Screw_open_L"
                            ></label>
                            <label
                              className={
                                'location_u set_appliance' +
                                (this.state.appliance_types.get('U') ===
                                'Bionator_without_Screw_open_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Bionator_without_Screw_open_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Bionator without Screw(close)
                            </span>
                            <label
                              className={
                                'location_l set_appliance' +
                                (this.state.appliance_types.get('L') ===
                                'Bionator_without_Screw_close_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Bionator_without_Screw_close_L"
                            ></label>
                            <label
                              className={
                                'location_u set_appliance' +
                                (this.state.appliance_types.get('U') ===
                                'Bionator_without_Screw_close_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Bionator_without_Screw_close_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Twin Block Without Screw
                            </span>
                            <label
                              className={
                                'location_l set_appliance' +
                                (this.state.appliance_types.get('L') ===
                                'Twin_Block_Without_Screw_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Twin_Block_Without_Screw_L"
                            ></label>
                            <label
                              className={
                                'location_u set_appliance' +
                                (this.state.appliance_types.get('U') ===
                                'Twin_Block_Without_Screw_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Twin_Block_Without_Screw_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - Herbst Telescopic with TPA and LLHA
                            </span>
                            <label
                              className={
                                'location_l set_appliance' +
                                (this.state.appliance_types.get('L') ===
                                'Herbst_Telescopic_with_TPA_and_LLHA_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Herbst_Telescopic_with_TPA_and_LLHA_L"
                            ></label>
                            <label
                              className={
                                'location_u set_appliance' +
                                (this.state.appliance_types.get('U') ===
                                'Herbst_Telescopic_with_TPA_and_LLHA_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="Herbst_Telescopic_with_TPA_and_LLHA_U"
                            ></label>
                          </div>
                          <div className="location">
                            <span className="appliances">
                              - MARA with TPA and LLHA
                            </span>
                            <label
                              className={
                                'location_l set_appliance' +
                                (this.state.appliance_types.get('L') ===
                                'MARA_with_TPA_and_LLHA_L'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
                              ...
                              id="MARA_with_TPA_and_LLHA_L"
                            ></label>
                            <label
                              className={
                                'location_u set_appliance' +
                                (this.state.appliance_types.get('U') ===
                                'MARA_with_TPA_and_LLHA_U'
                                  ? ' active'
                                  : '')
                              }
                              onClick={(event) => {
              ...
              <div className="inp-drawing col-md-7">
                <div className="canvas">
                  ...
                  <div className="drawing-tool">
                    <p className="overview-titles">DRAWING</p>
                    ...
                    >
                      <img
                        src="../images/newcase/icon/undo.png"
                        width="30"
                        alt="undo"
                      />
                    </button>
                    ...
                    >
                      <img
                        src="../images/newcase/icon/reset.png"
                        width="30"
                        alt="reset"
                      />
                    </button>
          ...
          <div className="part-value section-bands mt-3">
            <div className="row">
              <div className="section-bands title col-md-3">
                <b>
                  Add Bands<span className="text-danger">&nbsp;(Required)</span>
                </b>
              </div>
          ...
          <div className="part-value section-instruction mt-3">
            <div className="row">
              ...
              <div className="inp-instructions col-md-9">
                ...
                <input type="checkbox" id="bc-u" hidden />
                <input type="checkbox" id="bc-l" hidden />
                <input type="checkbox" id="cc-u" hidden />
                <input type="checkbox" id="cc-l" hidden />
                <input type="checkbox" id="ac-u" hidden />
                <input type="checkbox" id="ac-l" hidden />
                <input type="checkbox" id="pontic-u" hidden />
                <input type="checkbox" id="pontic-l" hidden />
              </div>
            </div>
          </div>
              ...
              {({ getRootProps, getInputProps }) => (
                <section className="container dropzone">
                  <div {...getRootProps({ className: 'field dropzone' })}>
                    <input {...getInputProps()} />
                    <p>
                      &#43;&nbsp;Drop <b>STL Upload</b> here to upload
                    </p>
                  </div>
                  <aside>
                    {/*<h4>Files</h4>*/}
