...
class NewCase extends Component {
  ...
  componentDidMount(){
    this.props.myInformation().then((a)=>{
      ...
      data_state.doctor_office_name = a.name;
      data_state.addr = a.street + " " + a.apartment;
      data_state.city =  a.city;
      data_state.state = a.state;
      data_state.zip = a.zipcode;
      data_state.phone = "tobesolved";//a.Phone;
      data_state.email = a.email;
...
export default connect(mapStateToProps, {myInformation})(NewCase);
