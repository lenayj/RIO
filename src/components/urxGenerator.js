import react, { Component } from "react"
 ...
 class UrxGenerator extends Component{
    ...
    addCheckForDueDate(dueDate){
        switch(dueDate){
            case "Normal": return <img className="labslip-inner-element" style={{top:"300px",left:"7px"}} src="/images/newcase/form/check.png" />;
            case "Rush" : return <img className="labslip-inner-element" style={{top:"300px",left:"75px"}} src="/images/newcase/form/check.png" />;
            default: return null;
        }
    }
        ...
        return (
            <div id="labslip">
                <div className="canvas-contents">
                    <img src={this.state.formImageSrc} />
